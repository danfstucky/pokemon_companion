    ...
    <div className={styles.flexWrapper}>
        ...
        <div className="card about-me-card">
          ...
          <div className={`card-body ${styles.aboutMeCard}`}>
            ...
            <p>
              ...
              {' '}and{' '}
              <a href="https://www.rust-lang.org/" target="_blank" rel="noreferrer">Rust</a>. I
        ...
        <div className="card">
          ...
          <div className="card-body">
            <ul className="list-unstyled">
              <li><i className="fas fa-graduation-cap" /> B.S. Computer Science</li>
              <li className="text-secondary">University of Missouri Kansas City (2016)</li>
            </ul>
            <ul className="list-unstyled">
              <li><i className="fas fa-graduation-cap" /> M.S. Molecular Genetics</li>
              <li className="text-secondary">Kansas State University (2013)</li>
            </ul>
            <ul className="list-unstyled">
              <li><i className="fas fa-graduation-cap" /> B.S. Biology</li>
      ...
      <div className={`${styles.column} ${styles.column2}`}>
        ...
        <div className="card">
          ...
          <div className="card-body">
            <p><i className="fas fa-map-marker-alt" /> Kansas City, MO</p>
            <p>
