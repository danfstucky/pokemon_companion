            ...
            >
              ...
              <div className="carousel-inner">
                {[screenshot1, screenshot2, screenshot3, screenshot4, screenshot5,
                  screenshot6, screenshot7, screenshot8, screenshot9, screenshot10].map((src, i) => (
        ...
        <div className={`card-body ${styles.flexWrapper}`}>
          ...
          <div className={`${styles.smiteSpecImagesContainer} ${styles.column} ${styles.column3}`}>
            <table className={styles.smiteSpecImages}>
              <tbody>
                <tr>
                  <td><img src={smiteScreenshot1} alt="Smite Spec 1" /></td>
                  <td><img src={smiteScreenshot2} alt="Smite Spec 2" /></td>
                  <td><img src={smiteScreenshot3} alt="Smite Spec 3" /></td>
                </tr>
              </tbody>
            </table>
          </div>
