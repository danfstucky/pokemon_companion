  ...
  return (
    <div className={`m-3 card ${styles.cardBorder}`}>
      ...
      <p className={`p-3 ${styles.helperText}`}>
        ...
        <a href="https://github.com/david-tejada/rango" target="_blank" rel="noreferrer">
          Rango
        </a>{' '}
      ...
      <div className="card-body">
        <h5>Hints</h5>
        <p>
          Hints are letter markers that appear next to interactable elements on a webpage. For example, a button may
          have the hints <code>ac</code> appear next to it. You can use these hints to interact with the element: click,
          hover, copy its text content, etc. Hints will only show up if the Rango browser extension is enabled.
        </p>
        <table className="table table-striped table-hover table-bordered">
          ...
          <tbody>
            ...
            <tr>
              <td>
                hints {e('on, off')} {e('now, page, host, tab')}
              </td>
              <td>
                ...
                <table className="table table-striped table-bordered">
                  <tbody>
                    <tr>
                      <td>now</td>
                      <td>
                        This is the highest level of priority. The hints will be toggled on/off for the current page
                        until the page is reloaded or the user navigates to another page.
                      </td>
                    </tr>
                    <tr>
                      <td>page</td>
            ...
            <tr>
              ...
              <td>
                ...
                <p>
                  Clicks on the element denoted by the hints (target). For example, saying &quot;air cap&quot; will
                  click on the element marked by <code>ac</code>. If <code>rango_direct_clicking</code> is disabled,
                  then you must precede all hints with &quot;click&quot;. For example, &quot;click air cap&quot;. This
                  is useful for avoiding accidental clicks. This setting exists in <code>rango.talon</code>.
                </p>
              </td>
            </tr>
            <tr>
              ...
              <td>
                ...
                <p>
                  Dispatches a hover event to the selected element. Sometimes this command doesn&apos;t have a visible
                  result if the current page doesn&apos;t have a hover event handler for this element.
                </p>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                ...
                because the browser thinks there was no user interaction and disallows it. This command may work in
                those cases.
              </td>
            </tr>
            <tr>
              ...
              <td>
                Opens the link in a new tab. If you use multiple targets all the links will open in new tabs and the
            ...
            <tr>
              ...
              <td>
                Opens the link in a new tab without focusing that tab. When using direct clicking and multiple targets
                you can omit the word stash. For example, saying &quot;air bat and air drum&quot; will open the links
                with the hints <code>ah</code> and <code>ad</code> in a new tab without stealing focus from the current
                one.
              </td>
            </tr>
            <tr>
        ...
        <table className="table table-striped table-hover table-bordered">
          ...
          <tbody>
            ...
            <tr>
              <td>center {e('target')}</td>
              <td>Scrolls the element to the center of the page/container.</td>
            </tr>
            <tr>
              <td>bottom {e('target')}</td>
              <td>Scrolls the element to the bottom of the page/container.</td>
            </tr>
            <tr>
              <td>scroll save {e('word')}</td>
              <td>Store the current scroll position and assign it to the specified word.</td>
            </tr>
            <tr>
              <td>scroll to {e('word')}</td>
              <td>
                Scroll to the saved position. This uses fuzzy search, so a command like &quot;scroll to object&quot;
                will also match the saved scroll position &quot;objects&quot; if no scroll position &quot;object&quot;
                was stored.
              </td>
            </tr>
          </tbody>
        ...
        <table className="table table-striped table-hover table-bordered">
          ...
          <tbody>
            ...
            <tr>
              <td>tab close first {e('number')}</td>
              <td>
                Closes the amount of tabs specified (or one if no number is given) starting from the leftmost tab.
              </td>
            </tr>
            <tr>
              <td>tab close final {e('number')}</td>
              <td>
                Closes the amount of tabs specified (or one if no number is given) starting from the rightmost tab.
              </td>
            </tr>
            <tr>
              <td>tab close previous {e('number')}</td>
              <td>
                Closes the amount of tabs specified (or one if no number is given) to the left of the current tab.
              </td>
            </tr>
            <tr>
              <td>tab close next {e('number')}</td>
              <td>
                Closes the amount of tabs specified (or one if no number is given) to the right of the current tab.
              </td>
            </tr>
          </tbody>
        </table>
