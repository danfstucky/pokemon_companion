  ...
  return (
    <div className={`m-3 card ${styles.cardBorder}`}>
      ...
      <p className={`p-3 ${styles.helperText}`}>
        When in dictation mode, most speech will be transcribed directly as it&apos;s spoken. Dictation mode is great
        for when you need to write a text document or email with lots of text. However, there are a few commands that
        are recognized while in dictation mode.
      </p>
        ...
        <table className="table table-striped table-hover table-bordered">
          ...
          <tbody>
                ...
                <table className="table table-striped table-bordered">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        Presses the &quot;ctrl-f&quot; keys to bring up a search box (if using app that supports
                        search).
                      </td>
                    </tr>
                    <tr>
            ...
            <tr>
              ...
              <td>
                &quot;cap hello world and cap goodbye&quot; will be written as &quot;Hello world and Goodbye&quot;.
              </td>
            </tr>
            <tr>
              <td>no cap</td>
            ...
            <tr>
              ...
              <td>
                &quot;go left 1 word&quot; will shift the cursor 1 word to the left. If there is not 1 more word to the
                left on the current line, the cursor will move up to the previous line or to the start of the line if
            ...
            <tr>
              ...
              <td>
                &quot;go right 2 words&quot; will shift the cursor 2 words to the right. If there are not 2 more words
                to the right on the current line, the cursor will move down to the next line or to the end of the line
              ...
              <td>
                <p>
                  ...
                  <span className={styles.sampleLine}>
                    &quot;Hello world. Talon<i className="bi bi-cursor-text"></i> is fun!&quot;
                  </span>
                </p>
                <p>The command &quot;select left 3 words&quot; will result in the following selection:</p>
                <p>
                  <span className={styles.sampleLine}>
                    &quot;Hello <span className={styles.lineSelection}>world. Talon</span> is fun!&quot;
                  </span>
                </p>
            ...
            <tr>
              ...
              <td>
                <p>
                  Given the line:{' '}
                  <span className={styles.sampleLine}>
                    &quot;<i className="bi bi-cursor-text"></i>Hello world. Talon is fun!&quot;
                  </span>
                </p>
                <p>The command &quot;select right 5 words&quot; will result in the following selection:</p>
                <p>
                  <span className={styles.sampleLine}>
                    &quot;<span className={styles.lineSelection}>Hello world. Talon is</span> fun!&quot;
                  </span>
                </p>
                <p>Note that the period (or any punctuation such as a comma, question mark, etc.) counts as a word.</p>
              </td>
            ...
            <tr>
              ...
              <td>
                ...
                <p>
                  <span className={styles.sampleLine}>
                    &quot;Hello world. Ta<span className={styles.lineSelection}>lon</span> is fun!&quot;
                  </span>
                </p>
            ...
            <tr>
              ...
              <td>
                <p>
                  Given the line:{' '}
                  <span className={styles.sampleLine}>
                    &quot;Hello wor<i className="bi bi-cursor-text"></i>ld. Talon is fun!&quot;
                  </span>
                </p>
                <p>The command &quot;select right 5 characters&quot; will result in the following selection:</p>
                <p>
                  <span className={styles.sampleLine}>
                    &quot;Hello wor<span className={styles.lineSelection}>ld. T</span>alon is fun!&quot;
                  </span>
                </p>
                <p>Note that spaces count as characters.</p>
              </td>
            ...
            <tr>
              ...
              <td>
                ...
                <p>
                  <span className={styles.sampleLine}>&quot;Hello Talon is fun!&quot;</span>
                </p>
                <p>Note that the period (or any punctuation such as a comma, question mark, etc.) counts as a word.</p>
              </td>
            </tr>
            <tr>
              ...
              <td>
                ...
                <p>
                  <span className={styles.sampleLine}>&quot;fun!&quot;</span>
                </p>
                <p>Note that the period (or any punctuation such as a comma, question mark, etc.) counts as a word.</p>
              </td>
            </tr>
            <tr>
              ...
              <td>
                ...
                <p>
                  <span className={styles.sampleLine}>&quot;Hello world. Ta is fun!&quot;</span>
                </p>
                <p>Note that spaces count as characters.</p>
              </td>
            </tr>
            <tr>
              ...
              <td>
                ...
                <p>
                  <span className={styles.sampleLine}>&quot;Hello woralon is fun!&quot;</span>
                </p>
                <p>Note that spaces count as characters.</p>
              </td>
            </tr>
            <tr>
              ...
              <td>
                A phrase is the last group of spoken words without a pause. Saying &quot;Hello world&quot;, followed by
                a pause, followed by &quot;scratch that&quot; will delete the &quot;hello world&quot; phrase.
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                A phrase is the last group of spoken words without a pause. Saying &quot;Hello world&quot;, followed by
                a pause, followed by &quot;select that&quot; will select the &quot;hello world&quot; phrase.
              </td>
            </tr>
            <tr>
            ...
            <tr>
              <td>
                spell that {e('formatters')} {e('letters')}
              </td>
            ...
            <tr>
              ...
              <td>
                &quot;hello world period talon is fun exclamation mark&quot; will be written as &quot; hello world
                period talon is fun exclamation mark&quot;.
                <br />
                Note that the punctuation is written out.
              </td>
            </tr>
          </tbody>
        </table>
