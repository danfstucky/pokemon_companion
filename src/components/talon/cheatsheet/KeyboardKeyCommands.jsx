    ...
    <div className={`m-3 card ${styles.cardBorder}`}>
      ...
      <div className="card-body">
          ...
          <tbody>
            <tr>
              ...
              <td>
                ...
                command for &quot;a&quot; would be &quot;air&quot;. Saying &quot;alphabet help&quot; will bring up a
                display of your alphabet.
              </td>
            </tr>
            <tr>
        ...
        <div className="row">
          <div className="col">
            <table className="table table-striped table-hover table-bordered">
              ...
              <tbody>
                <tr>
                  <td>period, dot, point</td>
                  <td>.</td>
                </tr>
                <tr>
                  <td>question, question mark</td>
                  <td>?</td>
                </tr>
                <tr>
                  <td>exclamation point, exclamation mark, bang</td>
                  <td>!</td>
                </tr>
                <tr>
                  <td>L square, left square, square</td>
                  <td>[</td>
                </tr>
                <tr>
                  <td>R square, right square</td>
                  <td>]</td>
                </tr>
                <tr>
          ...
          <div className="col">
            <table className="table table-striped table-hover table-bordered">
              ...
              <tbody>
                <tr>
                  <td>underscore, down score</td>
                  <td>_</td>
                </tr>
                <tr>
                  <td>paren, left paren</td>
                  <td>(</td>
                </tr>
                <tr>
                  <td>right paren</td>
                ...
                <tr>
                  <td>brace, left brace, bracket, left bracket</td>
                  <td>{'{'}</td>
                </tr>
                <tr>
                  <td>right brace, right bracket</td>
                  <td>{'}'}</td>
                </tr>
                <tr>
                  <td>tilde</td>
                ...
                <tr>
                  <td>angle, left angle, less than</td>
                  <td>{'<'}</td>
                </tr>
                <tr>
                  <td>rangle, right angle, greater than</td>
                  <td>{'>'}</td>
                </tr>
                <tr>
                  <td>star, asterisk</td>
                ...
                <tr>
                  <td>hash, hash sign</td>
                  <td>#</td>
                </tr>
                <tr>
                  <td>percent, percent sign</td>
                  <td>%</td>
                </tr>
              </tbody>
            </table>
          ...
          <div className="col">
            <table className="table table-striped table-hover table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  <td>and sign, amper, ampersand,</td>
                  <td>&amp;</td>
                </tr>
                <tr>
                  <td>pipe</td>
                ...
                <tr>
                  <td>dub quote, double quote</td>
                  <td>&quot;</td>
                </tr>
                <tr>
                  <td>quote, apostrophe</td>
                  <td>&apos;</td>
                </tr>
                <tr>
                  <td>dollar, dollar sign</td>
                  <td>$</td>
                </tr>
                <tr>
                  <td>pound, pound sign</td>
                  <td>£</td>
                </tr>
                <tr>
                  <td>backtick, grave</td>
                  <td>`</td>
                </tr>
                <tr>
                  <td>comma</td>
        ...
        <div className="row">
          ...
          <div className="col">
            <h5 id="modifier-keys" className="mt-5">
              Modifier Keys
            </h5>
            <table className="table table-striped table-hover table-bordered">
              <thead className="thead-dark">
              ...
              <tbody>
                ...
                <tr>
                  <td>super</td>
                  <td>super. On windows, this brings up the Start menu.</td>
                </tr>
              </tbody>
            </table>
          </div>
