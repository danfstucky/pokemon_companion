    ...
    encounters: [
      {
        ...
        pokemon: [
          ...
          { name: 'CRAWDAUNT', id: 342, level: '24-29' },
    ...
    encounters: [
      {
        ...
        pokemon: [
          ...
          { name: 'RAPIDASH', id: 78, level: '25-29' },
          { name: 'SUDOWOODO', id: 185, level: '25-29' },
          { name: 'PERSIAN', id: 53, level: '25-29' },
        ],
      },
      {
        terrain: 'Surf',
    ...
    encounters: [
      {
        ...
        pokemon: [
          ...
          { name: 'GRANBULL', id: 210, level: '35-39' },
    ...
    encounters: [
      {
        terrain: 'Land',
        pokemon: [
          { name: 'NIDOKING', id: 34, level: '42-47' },
          { name: 'NIDORINA', id: 30, level: '42-47' },
          { name: 'ARIADOS', id: 168, level: '42-47' },
          { name: 'DELIBIRD', id: 225, level: '42-47' },
          { name: 'XATU', id: 178, level: '42-47' },
          { name: 'CLEFABLE', id: 36, level: '42-47' },
          { name: 'SLOWKING', id: 199, level: '42-47' },
          { name: 'MAGMAR', id: 126, level: '42-47' },
          { name: 'ELECTABUZZ', id: 125, level: '42-47' },
          { name: 'TANGROWTH', id: 465, level: '42-47' },
          { name: 'CHANSEY', id: 113, level: '42-47' },
        ],
      },
      {
        terrain: 'Surf',
